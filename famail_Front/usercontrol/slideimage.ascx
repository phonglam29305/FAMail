...
<div class="sectionTop">
    	...
    	<a href="tinh-nang-he-thong/Bang-gia.aspx">
          ...
          <asp:HyperLink ID="HyperLink1" runat="server" href="#inline_dungthu" ImageUrl="~/images/btndangkydungthu.png" CssClass="inline"></asp:HyperLink> 
    	
   		</div>
    </div>
    <div class="sectionTabs">
	<div class="features">Chức năng Email Marketing</div>
	<!-- <div class="viewAll"><a href="#"><img src="../css/images/viewalltab.png" alt="View All" /></a></div> -->
	<div class="shadowleft"></div>
	<div class="shadowright"></div>

</div>

<%----------------form dùng thử hệ thống-----------------------------------------%>
       <div style='display:none'>
            <div id='inline_dungthu'>
                  <h3>Bạn muốn dùng thử hệ thống FA Mail với gói 2$ ?</h3>
                  <div class="btnyes">
                      <asp:LinkButton ID="LinkButton4" runat="server" CssClass="inline" href="#inline_dangky">
                          <asp:Image ID="imgyes" runat="server" ImageUrl="~/images/imagesfrom/btnyes.png" Width="150px" />
                      </asp:LinkButton>
                  </div>
                  <div class="btnno">
                      <asp:LinkButton ID="LinkButton1" runat="server">
                          <asp:Image ID="imgno" runat="server" ImageUrl="~/images/imagesfrom/btnno.png" Width="150px" />
                      </asp:LinkButton>
                  </div>        
			</div>
        </div>
<%-------------END: form dùng thử hệ thống---------------------------------------%>
...
<%------------------------form Login-----------------------------------------%>
        ...
        <div style='display:none'>
			<div id='inline_dangnhap'>

			    <h3>Đăng nhập FA Mail</h3>
                     <div class="divdangnhap">

                        <div class="box-fcdn">
                          <div class="labelfcdn"> 
                              <span style="font-size:16px ; ">Email</span>                              
                              <asp:Label ID="Label4" runat="server" Text="(Là tên đăng nhập của bạn):" BorderStyle="None" Font-Size="13px" Font-Italic="True"></asp:Label>
                          </div>
                          <div class="divbox">  
                        ...
                        <div class="box-btndangnhap">
                            <asp:LinkButton ID="LinkButton3" runat="server" CssClass="inline" href="#inline_dangky">
                                <asp:Image ID="Image4" runat="server" ImageUrl="~/images/imagesfrom/btndangnhap.png" Width="150px" />
                            </asp:LinkButton>
                        </div>
