                ...
                <div class="content-module-main cf">
                    <div class="half-size-column fl" style="height: auto">
                        ...
                        <fieldset>
                            ...
                            <p>                                
                                <asp:CheckBox ID="ceUnLimit" runat="server" Text="Không giới hạn"/>
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <asp:CheckBox ID="ceIsActive" runat="server" Text="Kích hoạt" />
                            </p>
                            <p>
                    ...
                    <div class="full-width-editor" style="float: left; margin-top: -100px;">
                        <fieldset>
                        </fieldset>
                    </div>
