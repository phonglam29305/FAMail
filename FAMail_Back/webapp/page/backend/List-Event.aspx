    ...
    <div class="side-content fr">
        ...
        <div class="content-module">
            <div class="content-module-heading cf">
                <h3 class="fl">Danh sách sự kiện</h3>
            ...
            <div class="content-module-main">
                ...
                <asp:Panel ID="pnSearch" runat="server">
                    <table id="FilterTable">
                        <thead>
                            <tr>
                                <th colspan="6" style="height: 27px; padding-left: 10px; text-align: left">Tìm kiếm sự kiện
                                </th>
                            </tr>
                        </thead>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left" style="text-align: left;">
                                <p>
                                    <label for="full-width-input">Chọn nhóm mail</label>
                    ...
                    <asp:DataList ID="dlEvent" runat="server"
                        ...
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="lbtSubject" runat="server" Width="200px" PostBackUrl='<%#"~/webapp/page/backend/event-report.aspx?id="+Eval("eventid") %>' ></asp:LinkButton>
                                    </td>
                                    <td>
