<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="quy-dinh-ve-su-dung-dich-vu.aspx.cs" Inherits="quy_dinh_ve_su_dung_dich_vu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        ...
        <div class="span3 bs-docs-sidebar">
            <ul class="nav nav-list bs-docs-sidenav" style="position:relative !important;">
        ...
        <div class="span9" style="overflow:hidden;">
            <div style="height:625px;overflow-y:scroll;width:716px; ">
            <section id="loi-mo-dau">
                <div class="page-header">
                    <h3>Lời mở đầu</h3>
                </div>
                <div class="row-fluid">
                    <p style="text-align: justify; margin: 0px; -moz-user-select: text ! important; font-size:14px; padding-top:20px">
