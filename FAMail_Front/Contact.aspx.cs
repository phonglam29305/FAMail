...
public partial class Support : System.Web.UI.Page
{
    ...
    protected void image_Click(object sender, ImageClickEventArgs e)
    {
        ...
        mail.From = new MailAddress("support@fastautomaticmail.com",
        ...
        mail.Body += "<html>  <body><table class='auto-style1'> <tr><td>Chào " + txtten.Text + "</td></tr><tr><td>Chúng tôi đã nhận được câu hỏi của bạn với nội dung sau </td></tr><tr><td>" + txtconten.Text + "</td></tr><tr><td>Chúng tôi sẽ trả lời trong vòng 12 giờ tới .Đây là Email tự động xin vui lòng đừng trả lời </td></tr><tr><td>Bộ phận khách hàng online</td></tr></table></body>  "; mail.Body += "</html>";
